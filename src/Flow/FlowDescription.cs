...
namespace MicroFlow
{
    public sealed class FlowDescription
    {
        ...
        [CanBeNull] public IFlowNode InitialNode { get; }
        [CanBeNull] public IFaultHandlerNode DefaultFaultHandler { get; }
        [CanBeNull] public IActivityNode DefaultCancellationHandler { get; }
        [NotNull] public ReadOnlyCollection<IFlowNode> Nodes { get; }
        [NotNull] public ReadOnlyCollection<IVariable> GlobalVariables { get; }
    }
}