...
namespace MicroFlow
{
    ...
    {
        private readonly List<Guid> _dependencies = new List<Guid>();

        public ReadOnlyCollection<Guid> Dependencies => new ReadOnlyCollection<Guid>(_dependencies);
                ...
                if (node.Object.Type.Is<IResult>())
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            _dependencies.Add(result.SourceId);
                        }
                    }
                }
            }
