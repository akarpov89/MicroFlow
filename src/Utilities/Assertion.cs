...
namespace MicroFlow
{
  internal static class Assertion
  {
    ...
    public static void AssertNotNull<T>([AssertionCondition(AssertionConditionType.IS_NOT_NULL)] this T value,
    ...
    [DebuggerStepThrough, AssertionMethod]
    public static void AssertIsNull<T>([AssertionCondition(AssertionConditionType.IS_NULL)] this T value,
      [NotNull] string message) where T : class
    {
      if (null == value) return;
      throw new AssertionException(message);
    ...
    [DebuggerStepThrough, AssertionMethod]
    public static void AssertTrue([AssertionCondition(AssertionConditionType.IS_TRUE)] this bool condition,
    ...
    [DebuggerStepThrough, AssertionMethod]
    public static void AssertFalse([AssertionCondition(AssertionConditionType.IS_FALSE)] this bool condition,
      [NotNull] string message)
    {
      if (!condition) return;
      throw new AssertionException(message);
