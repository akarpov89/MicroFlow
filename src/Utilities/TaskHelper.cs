...
namespace MicroFlow
{
  ...
  {
    private static Task myCompletedTask;
    private static Task myCancelledTask;
    ...
    public static Task CompletedTask
    {
      get
      {
        if (myCompletedTask == null)
        {
          myCompletedTask = FromResult(default(VoidTaskResult));
        }
    ...
    public static Task CancelledTask
    {
      get
      {
        if (myCancelledTask == null)
        {
          var tcs = new TaskCompletionSource<VoidTaskResult>();
          tcs.TrySetCanceled();
          myCancelledTask = tcs.Task;
        }
        return myCancelledTask;
      }
    }
